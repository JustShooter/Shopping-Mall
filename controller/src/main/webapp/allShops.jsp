            ...
            <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <c:forEach var="categoies" items="${allCategories}">
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/viewShopsInCategory?category=${categoies.getId()}"
                    ...
                    <div class="col-md-4">
                        <div class="card text-center">
                            <div class="card rounded-3 shadow-sm">
                                ...
                                <p class="card-footer">
                                    <a role="button"
                                       href="${pageContext.request.contextPath}/viewShopItems?shopId=${shop.getId()}"
                                       class="btn btn-info">Товары</a>
                                </p>
                            </div>
                        </div>
                    </div>
